...
> **Warning**: This README and the docs reference the 1.0.0 Version. **It does not support React Native by now** (coming soon). <br>Make sure to test it! `npm install react-look@1.0.0-beta1`.
